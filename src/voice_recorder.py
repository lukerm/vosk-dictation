...
TRANSCRIPTION_PATH_TMP = "/tmp/vosk_transcription_latest.txt"
...
if __name__ == "__main__":
    ...
    transcribed_fname = Path(TRANSCRIPTION_PATH) / f"transcription_{now_str}.txt"
    with open(transcribed_fname, "w") as text_file:
        text_file.write(transcribed_text)
    with open(TRANSCRIPTION_PATH_TMP, "w") as text_file:
        text_file.write(transcribed_text)
    print(f"""Full transcription saved to {transcribed_fname} \n\t\t\tand {TRANSCRIPTION_PATH_TMP}""")
